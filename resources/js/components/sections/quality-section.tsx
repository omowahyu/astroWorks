        ...
        <section className="pt-12 pb-4 px-4 lg:px-0">
            <div className="container mx-auto">
                <div className="grid lg:grid-cols-2 gap-4">
                    <div className="bg-gray-100 text-black text-center px-4 py-12 lg:p-12 flex flex-col items-center justify-start">
                    ...
                    <div className=" bg-linear-to-br from-[#D3EAF7] to-[#F8F8F8] text-black text-center px-4 py-12 lg:p-12 flex flex-col items-center justify-start ">
