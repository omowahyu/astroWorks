                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div className="bg-gray-100 text-black p-2 lg:p-12 flex flex-col items-center justify-start">
                        ...
                        <div className="flex justify-center items-center mt-12 h-full ">
                            <img src="/images/statics/company/JaminanTermurah.svg" alt="freeDesign&Cepat" className=" w-full  lg:h-56" />
                        </div>
                    </div>
                    <div className=" bg-linear-to-br from-[#D3EAF7] to-[#F8F8F8] text-black p-2 lg:p-12 flex flex-col items-center justify-start ">
                        ...
                        <div className="flex justify-center items-center mt-12">
                            <img src="/images/statics/company/JaminanKualitasProduksi.png" alt="Jaminan Kualitas Produksi AstroKabinet" className="object-cover w-full" />
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-100 text-black p-2 lg:p-12 flex flex-col items-center justify-start">
                        ...
                        <div className="flex justify-center items-center mt-12">
                            <img src="/images/statics/company/DynamicSpace.png" alt="Dynamic Space" className="object-cover w-full" />
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-100 text-black p-2 lg:p-12 flex flex-col items-center justify-start">
                        ...
                        <div className="flex justify-center items-center mt-12 w-full">
                            <img src="/images/statics/company/AksesInternasional.png" alt="Aksesoris Internasional" className="object-cover w-full" />
                        </div>
                    </div>
                </div>
            </div>
