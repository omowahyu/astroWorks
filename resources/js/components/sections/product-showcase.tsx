...
export default function ProductShowcase() {
    return (
        <section className="pt-12 pb-4 px-4 lg:px-0">
            <div className="container mx-auto">
                <h3 className="text-4xl font-bold text-gray-800 pb-6">Pilih Kabinet yang kamu butuh</h3>
                <div className="grid lg:grid-cols-2 gap-4 lg:gap-2 lg:gap-y-8">
                    <div className="bg-gray-200 text-black p-12 flex flex-col items-center justify-center h-[480px]"></div>
                    <div className="bg-gray-200 text-black p-12 flex flex-col items-center justify-center h-[480px]"></div>
                    <div className="bg-gray-200 text-black px-4 py-12 lg:p-12 flex flex-col items-center justify-start">
                        <h3 className="text-center text-4xl font-bold mb-4">Free Design & Cepat</h3>
                    ...
                    <div className="bg-gray-200 text-black px-4 py-12 lg:p-12 flex flex-col items-center justify-start">
                        <h3 className="text-center text-4xl font-bold mb-4">Jaminan termurah</h3>
                        <p className="text-center text-lg mb-6">
