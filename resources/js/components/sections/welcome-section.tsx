    ...
    return (
        <section className="py-12 bg-linear-to-br from-[#D3EAF7] to-[#F8F8F8]">
            <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-black font-medium mb-8 text-xl mx-auto">
                    Memberikan solusi Kebutuhan untuk rumah konsep mewah harga standard, Kebutuhan untuk bisnis yang butuh cepat
                    harga terjangkau.
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                    <Button className={`text-lg py-6 px-8 ${btnSolid}`}>Katalog</Button>
                    <Button variant="outline" className={`text-lg py-6 px-8 ${btnOutline} `}>Wardrobe</Button>
                    <Button variant="outline" className={`text-lg py-6 px-8 ${btnOutline} `}>TV Cabinet</Button>
                    <Button variant="outline" className={`text-lg py-6 px-8 ${btnOutline} `}>Shop Display</Button>
                </div>
            </div>
